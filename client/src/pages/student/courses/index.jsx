...
function StudentViewCoursesPage() {
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-50">
      <h1 className="text-4xl font-extrabold mb-6 text-center text-teal-600">All Courses</h1>
          ...
          <div>
            {Object.keys(filterOptions).map((ketItem) => (
              <div className="p-4 border-b" key={ketItem}>
                <h3 className="font-bold mb-3 text-lg text-teal-600">{ketItem.toUpperCase()}</h3>
        ...
        <main className="flex-1">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="flex items-center gap-2 p-5 text-teal-600 border-teal-600"
                >
          ...
          <div className="space-y-6">
            {studentViewCoursesList && studentViewCoursesList.length > 0 ? (
                ...
                >
                  <CardContent className="flex gap-4 p-4">
                    ...
                    <div className="flex-1">
                      <CardTitle className="text-xl mb-2 text-teal-600">
                        {courseItem?.title}
                      </CardTitle>
              ...
              <h1 className="font-extrabold text-4xl text-center text-teal-600">No Courses Found</h1>
            )}
          </div>
        </main>
      </div>
